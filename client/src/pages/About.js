  ...
  return (
    <div>
      ...
      <div className='relative py-10'>
        <h2 className='text-center text-2xl mb-2 font-bold'>About Daniel Interior Designs</h2>
        <h3 className='font-bold text-xl text-center mb-2'>Who we are</h3>
        <p className='text-center text-lg mb-2'>Daniel interior designs is a provider of design solutions</p>
        <p className='text-center text-lg mb-2'>We believe that your home or office should reflect your personal style and preferences. </p>
      </div>
      ...
      <div className='flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0 justify-center items-center py-8 px-4 md:px-20'>
        <div className='bg-indigo-100 hover:bg-indigo-200 shadow-lg w-full text-center md:w-1/3 p-10 rounded-lg transition-transform duration-300 ease-in-out transform:hover-translate-y-1 hover:scale-105'>
         <p>
        ...
        <div className='bg-violet-300 hover:bg-purple-200 shadow-lg w-full text-center md:w-1/3 p-10 rounded-lg transition-transform duration-300 ease-in-out transform:hover-translate-y-1 hover:scale-105'>
         <p>
        ...
        <div className='bg-green-100 hover:bg-purple-200 shadow-lg w-full text-center md:w-1/3 p-10 rounded-lg transition duration-300 ease-in-out transform:hover-translate-y-1 hover:scale-105'>
         <p>
          ...
          <p>We aim to connect people with their unique sense of style, creating spaces that resonate with their personal tastes & preferences.</p>
        </div>
      </div>

      <div className='mx-4 md:mx-20 py-8'>
          <h2 className='text-center text-xl mb-4 font-bold py-2'>Why choose us?</h2>
          <div className='flex flex-cols-1 md:flex-row md:space-x-6 space-y-6 md:space-y-0'>
