  ...
  return (
    <div>
      ...
      <div className='relative py-10 bg-gray-100'>
        <h3 className='font-bold text-2xl text-center mt-2'>We Are:</h3>
        <div className='text-center'>
          <p className='text-lg mb-4'>Daniel Interior Designs is a provider of bespoke design solutions</p>
          <p className='text-lg mb-4'>We believe that your home or office should reflect your personal style and preferences. </p>
        </div>
      </div>
      ...
      <div className='flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0 justify-center items-center py-8 px-4 md:px-20'>
        ...
        <div className='bg-purple-100 hover:bg-purple-200 shadow-lg w-full text-center md:w-1/3 p-10 rounded-lg transition-transform duration-300 ease-in-out transform:hover-translate-y-1 hover:scale-105'>
         <p>
        ...
        <div className='bg-teal-100 hover:bg-teal-200 shadow-lg w-full text-center md:w-1/3 p-10 rounded-lg transition duration-300 ease-in-out transform:hover-translate-y-1 hover:scale-105'>
         <p>
