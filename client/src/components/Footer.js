  ...
  return (
    <div className="bg-dark-blue">
      <div className="container mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="text-white mb-8 md:mb-0 md:w-1/3">
            ...
            <p className="mb-6">
              Let's connect on social media platforms for insights, latest news
              and engaging discussions.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/danielinteriors254?igsh=YzljYTk1ODg3Zg=="
              ...
              <a
                href="https://wa.me/message/5ASRCZOLWA2NP1"
                className="hover:opacity-75"
              >
                <FontAwesomeIcon
                  icon={faXTwitter}
              ...
              >
                <FontAwesomeIcon
                  icon={faInstagram}
                  className="rounded-full bg-pink-600 p-3 text-white"
                />
              </a>
              <a
                href="https://wa.me/message/5ASRCZOLWA2NP1"
              ...
              <a
                href="mailto:danielinteriordesigns@gmail.com"
                className="hover:opacity-75"
              >
                <FontAwesomeIcon
                  icon={faEnvelope}
                  className="rounded-full bg-gray-600 p-3 text-white"
                />
              </a>
            </div>
          </div>
      ...
      <div className="border-t border-gray-600 text-white text-center py-6">
        <p>
          All Rights Reserved. &copy;{new Date().getFullYear()} Daniel Interior
          Designs
        </p>
      </div>
    </div>
